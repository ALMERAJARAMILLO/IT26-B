...
(123456, 'noah', 'valez', 'noahvalez@gmail.com', 2),
(789901, 'alma', 'jaramillo', 'jaramilloalma@gmail.com', 3),
(812821, 'almera', 'jaramillo', 'jaramilloalmera@gmail.com', 4);
...
(2, 5315, '2025-05-08', 789901),
(3, 6789, '2025-05-09', 812821);
...
--
ALTER TABLE `customers`
  MODIFY `customer_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=812822;
